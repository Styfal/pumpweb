...
<main class="main">
  <div class="container modern">
    ...
    <div class="content">
      ...
      <div class="ctas">
        {{#BUY_LINK}}<a class="btn btn-primary" href="{{BUY_LINK}}" target="_blank">Buy {{TICKER}}</a>{{/BUY_LINK}}
...
<main class="minimal-main">
  <div class="container minimal">
    ...
    <div class="content">
      ...
      <div class="ctas">
        {{#BUY_LINK}}<a class="btn minimal-btn" href="{{BUY_LINK}}" target="_blank">Buy {{TICKER}}</a>{{/BUY_LINK}}
